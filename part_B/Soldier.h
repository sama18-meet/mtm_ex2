...
/**
* Soldier class - one of the three character types.  
...
private:
    ...
    */ 
    ...
    /**
    * attackInRange: Checks if the destination grid point is included in the Soldier's range that he can attack in.
    *                    Const grid point to insure we don't change it.
    ...
    */ 
    ...
    /**
    * legalTarget: Checks if current character can attack this target according to Soldier's requirments.
    *
    * @param GridPoint -
