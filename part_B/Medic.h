...
/**
* Medic class - one of the three character types.  
...
private:
    ...
    */ 
    ...
    /**
    * attackInRange: Checks if the destination grid point is included in the Medic's range that he can attack in.
    *                    Const grid point to insure we don't change it.
    ...
    */ 
    ...
    /**
    * legalTarget: Checks if current character can attack this target according to Medic's requirments.
    *
    * @param GridPoint -
